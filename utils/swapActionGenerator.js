...
function createERC20SwapLitAction(chainAParams, chainBParams) {
...
function generateUnsignedERC20Transaction(transactionParams) {
  return {
    ...
    gasLimit: "60000",
    from: transactionParams.from ? transactionParams.from : "{{pkpPublicKey}}",
...
module.exports = { createERC20SwapLitAction };
